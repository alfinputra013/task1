...
class MyHomePage extends StatelessWidget {
  ...
  children: <Widget>[
                        ...
                        Column(
                          children: [
                            Padding(
                              ...
                              child: Text('Oleh: M Alfin Mulya Putra', style: TextStyle(fontSize: 13, color: Colors.grey),),
                              ),
                              Padding(
    ...
    Padding(
      ...
      child: Text('Penulis: M Alfin Mulya Putra', style: TextStyle(fontSize: 13, color: Colors.blue),),
      ),
      Padding(
      padding: EdgeInsets.only(top: 2, left: 15),
      child: Text('Editor: Alfin Mulya Putra', style: TextStyle(fontSize: 13, color: Colors.blue),),
      ),
  ]
)
    );
